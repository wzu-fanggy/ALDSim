...
HfX2,HfHX2,HfH2X2,
HfHX,HfX,Hf,
OH2HfX,OH2HfHX,OH2Hf,OHHfHX,
AlX3O,AlX3OH,AlHX2O,AlHX2OH,AlH2XO,AlH2XOH,
AlX2O,AlX2OH,AlHXO,AlHXOH,AlXO,AlXOH,AlOH,
AlX2,AlHX2,AlH2X2,
AlHX,AlX,Al,
OH2AlX,OH2AlHX,OH2Al,
OH2,Si,
EVENTS,ONE,TWO,THREE
};       // Hf + Al, same as AppAld
...
void DiagAld::init()
{
  ...
  for (int i = 0; i < nlist; i++) {
      ...
      else if (strcmp(list[i],"AlHX2O") == 0) which[i] = AlHX2O;
      else if (strcmp(list[i],"AlHX2OH") == 0) which[i] = AlHX2OH;
      else if (strcmp(list[i],"AlH2XO") == 0) which[i] = AlH2XO;
      else if (strcmp(list[i],"AlH2XOH") == 0) which[i] = AlH2XOH;
      else if (strcmp(list[i],"AlX2O") == 0) which[i] = AlX2O;
      else if (strcmp(list[i],"AlX2OH") == 0) which[i] = AlX2OH;
      else if (strcmp(list[i],"AlHXO") == 0) which[i] = AlHXO;
      else if (strcmp(list[i],"AlHXOH") == 0) which[i] = AlHXOH;
      ...
      else if (strcmp(list[i],"AlHX2") == 0) which[i] = AlHX2;
      else if (strcmp(list[i],"AlH2X2") == 0) which[i] = AlH2X2;
      else if (strcmp(list[i],"AlHX") == 0) which[i] = AlHX;
      ...
      else if (strcmp(list[i],"OH2AlHX") == 0) which[i] = OH2AlHX;
...
// here as well we have to consider some modification, generally it does not seem so difficult
  if (siteflag) {
    sites[O] = 0; sites[OH] = 0; sites[Al] = 0;sites[VACANCY] = 0;
    sites[OH2] = 0; sites[OH2AlX] = 0; sites[OH2AlHX] = 0; sites[OH2Al] = 0;
    sites[AlX] = 0; sites[AlHX] = 0;
    sites[AlX2] = 0; sites[AlHX2] = 0; sites[AlH2X2] = 0;
    sites[AlX2O] = 0; sites[AlHXO] = 0; sites[AlXO] = 0;
    sites[AlX2OH] = 0; sites[AlHXOH] = 0; sites[AlXOH] = 0;
    sites[AlX3O] = 0; sites[AlHX2O] = 0; sites[AlH2XO] = 0;
    sites[AlX3OH] = 0; sites[AlHX2OH] = 0; sites[AlH2XOH] = 0;
        sites[HfX4O] = 0; sites[HfX4OH] = 0; sites[HfHX4O] = 0; sites[HfHX4OH] = 0;
    sites[HfH2X4O] = 0; sites[HfH2X4OH] = 0; sites[HfH3X4O] = 0; sites[HfH3X4OH] = 0;
    sites[HfH4X4O] = 0; sites[HfH4X4OH] = 0;
    sites[HfX3O] = 0; sites[HfX3OH] = 0; sites[HfHX3O] = 0; sites[HfHX3OH] = 0;
    sites[HfH2X3O] = 0; sites[HfH2X3OH] = 0; sites[HfH3X3O] = 0; sites[HfH3X3OH] = 0;
    ...
    sites[HfX] = 0; sites[HfHX] = 0; sites[Hf] = 0;
    sites[OH2HfX] = 0; sites[OH2HfHX] = 0; sites[OH2Hf] = 0; sites[OHHfHX] = 0;
sites[AlOH] = 0;
  ...
  for (int i = 0; i < nlist; i++) {
    ...
    else if (which[i] == OH2AlHX) ivalue = sites[OH2AlHX];
    else if (which[i] == OH2Al) ivalue = sites[OH2Al];
    else if (which[i] == OH2) ivalue = sites[OH2];
    else if (which[i] == AlX) ivalue = sites[AlX];
    else if (which[i] == AlHX) ivalue = sites[AlHX];
    else if (which[i] == AlX2) ivalue = sites[AlX2];
    else if (which[i] == AlHX2) ivalue = sites[AlHX2];
    else if (which[i] == AlH2X2) ivalue = sites[AlH2X2];
    else if (which[i] == AlX2O) ivalue = sites[AlX2O];
    else if (which[i] == AlHXO) ivalue = sites[AlHXO];
    else if (which[i] == AlXO) ivalue = sites[AlXO];
    else if (which[i] == AlX2OH) ivalue = sites[AlX2OH];
    else if (which[i] == AlHXOH) ivalue = sites[AlHXOH];
    else if (which[i] == AlXOH) ivalue = sites[AlXOH];
    else if (which[i] == AlX3O) ivalue = sites[AlX3O];
    else if (which[i] == AlHX2O) ivalue = sites[AlHX2O];
    else if (which[i] == AlH2XO) ivalue = sites[AlH2XO];
    else if (which[i] == AlX3OH) ivalue = sites[AlX3OH];
    else if (which[i] == AlHX2OH) ivalue = sites[AlHX2OH];
    else if (which[i] == AlH2XOH) ivalue = sites[AlH2XOH];
